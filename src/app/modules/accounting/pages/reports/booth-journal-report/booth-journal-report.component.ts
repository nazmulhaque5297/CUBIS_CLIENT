...
@Component({
  selector: 'app-booth-journal-report',
  templateUrl: './booth-journal-report.component.html',
  styleUrls: ['./booth-journal-report.component.css'],
})
export class BoothJournalReportComponent implements OnInit, OnDestroy {
  module: string = '3';
  ...
  constructor(
    ...
    this.reportModel.ReportName = 'CCULB_BoothrptMGLTransactionDetailList';
