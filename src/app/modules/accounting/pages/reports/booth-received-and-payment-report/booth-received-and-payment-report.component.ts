...
@Component({
  selector: 'app-booth-received-and-payment-report',
  templateUrl: './booth-received-and-payment-report.component.html',
  styleUrls: ['./booth-received-and-payment-report.component.css'],
})
export class BoothReceivedAndPaymentReportComponent
  ...
  constructor(
    ...
    this.reportModel.ReportName =
      'CCULB_BoothrptMGLReceivedPaymentRegisterByUnit';
