...
export class PensionProcessComponent implements OnInit, OnDestroy {
  ...
  onCalculation(): void {
    if (confirm('Are you sure?')) {
      ...
      this.pService
        .PensionInterestCalculation(formValue.AccountTypeId)
        .pipe(takeUntil(this.destroy$))
        .subscribe(
          (data) => {
  ...
  public setParameter1(): void {
    ...
    if (fValue.BranchCode == '') {
      ...
      this.reportModel.ReportName = 'rptCsPensionInterestReportAll';
    } else {
      this.reportModel.Values.push(
        new ReportKeyValue('BranchValue', fValue.BranchCode)
      );
      this.reportModel.ReportName = 'rptCsSBInterestReportPension';
    }
  ...
  public setParameter2(): void {
    ...
    if (fValue.BranchCode == '') {
      this.reportModel.Values.push(new ReportKeyValue('BranchValue', '0'));
      this.reportModel.ReportName = 'rptCsPensionInterestDetailReportAll';
    } else {
      this.reportModel.Values.push(
        new ReportKeyValue('BranchValue', fValue.BranchCode)
      );
      this.reportModel.ReportName = 'rptCsSBInterestDetailReportPension';
    }
